 ...
 * Author: mopel
 * Date : 2017/4/25
 * cssAnimation: https://github.com/daneden/animate.css/blob/master/source/zooming_entrances/zoomInDown.css
 */

public class ZoomInDownAnimator extends BaseAnimator {
  ...
  @Override protected void prepare(final View target) {
    ...
    Keyframe kf_translation_2 = Keyframe.ofFloat(.6f, 60);
